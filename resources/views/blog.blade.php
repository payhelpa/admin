                                ...
                                <div class="card-body">
                                    <div class="">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form method="POST" action="{{route('createblog')}}"  role="form">
                                                        @csrf
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-btn">
                                                                ...
                                                                Browse <input type="file" name="cover_image" id="cover_image" multiple>
                                                                </span>
                                                            </span>
                                                    ...
                                                    <div class="form-group">
                                                        <textarea class="form-control bcontent" id="body" name="body"></textarea>
                                                    </div>
                                                    <div class="form-group">
