...
<div class="card-body">
    <div style="display: flex; float: right; margin-buttom:-40px; ">
        <a href="{{route ('addcountry')}}" class='btn btn-primary mr-2'>Add Country</a>
    </div>
...
<tbody>
    ...
    <tr>
        ...
        <td class="text-right">
            <div class="actions">
                <a href="{{ route('country.edit',$country->id) }}"><i class="fe fe-edit" style="margin-right: 10px; margin-left: 10px"></i></a>
