...
<h4 class="card-title">List of Tags</h4>
<!--<p class="card-text">
...
<div class="card-body">
    <div style="display: flex; float: right; margin-buttom:-40px; ">
        <a href="{{route ('addtag')}}" class='btn btn-primary mr-2' >Create</a>
    </div>
...
<tbody>
    ...
    <tr>
        ...
        <td class="text-right">
            <div class="actions">
                <a href="{{ route('tag.edit',$tag->id) }}"><i class="fe fe-edit" style="margin-right: 10px; margin-left: 10px"></i></a>
                <a href="{{ route('tag.delete',$tag->id) }}"><i class="fe fe-trash"></i></a>
            </div>
        </td>
    </tr>
    @endforeach
